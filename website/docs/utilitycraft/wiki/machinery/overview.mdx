...
| Wind Turbine | Wind conditions | Creates energy based on altitude and weather conditions. |
...
<p align="center">
  <img 
    src="/img/addons/utilitycraft/machinery/pics/machine_using_energy_example.jpg" 
...
Energy in UtilityCraft can move in three main ways: **direct contact**, **energy cables**, and **transmitter/receiver channels**.
...
<Carousel showThumbs={false} showStatus={false} infiniteLoop emulateTouch>
  <div>
    <img 
      src="/img/addons/utilitycraft/machinery/pics/energy_contact_transfer.jpg" 
...
Using cables helps keep your network organized and allows longer-distance physical connections between machines and generators.

For channel-based routing, UtilityCraft already includes **Transmitters & Receivers** with configurable network channels.

See:

- [Transport Systems](./transport)
- [Wireless Energy](./transport/utilitycraft-wireless-energy)
- [Machine Upgrades](./upgrades)
