...
<div style={{ display: "flex", justifyContent: "center", gap: "2rem", flexWrap: "wrap", marginBottom: "1rem" }}>
	<div style={{ textAlign: "center" }}>
		...
		/>
		<p style={{ marginTop: "0.5rem", fontWeight: "600" }}>Energy Transmitter & Receiver</p>
	</div>
</div>

<p style={{ textAlign: "center", maxWidth: "760px", margin: "0 auto 1rem auto" }}>
	The <b>Energy Transmitter</b> and <b>Energy Receiver</b> let you send Dorios Energy wirelessly — no cables needed.
