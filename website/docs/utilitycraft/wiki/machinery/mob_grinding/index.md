...
UtilityCraft provides a set of blocks designed to automate mob farming — from spawning and killing mobs to collecting the experience they drop.

| Block | What It Does |
|-------|-------------|
| [Mob Grinder](./mob_grinder) | Continuously damages nearby entities within a configurable radius. |
