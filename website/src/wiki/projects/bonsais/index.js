...
const project = createGeneratedProject({
  ...
  overview: {
    ...
    description: "Generated reference for Bountiful Bonsais, mapped directly from its behavior pack, resource pack, recipes, entities, blocks, items, and project assets.",
