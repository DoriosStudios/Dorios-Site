...
const project = createGeneratedProject({
  ...
  overview: {
    ...
    description: "Generated reference for Better Smelters, mapped directly from its behavior pack, resource pack, recipes, entities, blocks, items, and project assets.",
